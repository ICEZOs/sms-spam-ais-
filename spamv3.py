...
print ("\n\n\nกรุณาใส่ข้อมูลที่ระบบต้องการนะครับบบ")
time.sleep(2)
os.system("clear")
...
print ("\n\n\nกรุณาพิมพ์เบอร์ลงในช่องที่ให้ไว้ ลบ 0 ออกแล้วขึ้นต้นด้วย 66\n\n\n\n")
numbers = int(input("เบอร์เป้าหมาย : "))
print ("ระบบได้บันทึกเบอร์โทรเรียบร้อยแล้ว")
os.system("clear")
...
print ("\n\n\nกรุณาพิมพ์จำนวนรอบที่ต้องการลงในช่องที่ให้ไว้\n\n\n\n")
count = int(input("จำนวนรอบ : "))
print ("ระบบได้บันทึกจำนวนเรียบร้อยแล้ว")
...
print ("\n\n++==------------โจมตีสำเร็จแล้ว------------==++\n\n")
print ("\n\n\n\nระบบกำลังปิดโปรแกรมให้นะครับ ขอบคุณที่ใช้งาน")
time.sleep(2)
os.close